...
//            }
                ...
                if (position2 == 0) {
                    ...
                    long i = adapter.insertTrip(name, spoint, sLong, sLat, epoint, eLong, eLat, status, sdate, sdate, totaltime, null, rep, user, null);
...
//                    myCalTwo.set(Calendar.MINUTE,returnmin);
                    ...
                    if (myCalTwo.before(myCalOne)) {
                        ...
                        Log.i("insertsql", "done");
                        long i = adapter.insertTrip(name, spoint, sLong, sLat, epoint, eLong, eLat, status, sdate, rdate, totaltime, null, rep, user, null);
                        long i2 = adapter.insertTrip(name, epoint, eLong, eLat, spoint, sLong, sLat, status, rdate, rdate, rtime, null, rep, user, null);
                        inserted2 = true;
                    }
                    ////////////////////////
                }
