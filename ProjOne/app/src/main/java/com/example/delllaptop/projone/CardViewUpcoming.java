    ...
    public void onBindViewHolder(CardViewHolder holder, final int position) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(item.getItemId() == R.id.cancelAct){
                            ...
                            long i2 = adapter.updateTrip(trips.get(position).getId(),trips.get(position).getName(),trips.get(position).getSp(),trips.get(position).getSlong(),trips.get(position).getSlat(),trips.get(position).getEp(),trips.get(position).getElong(),trips.get(position).getElat(), trips.get(position).getStatus(),trips.get(position).getSd(),trips.get(position).getSd(),trips.get(position).getSt(),trips.get(position).getSt(),trips.get(position).getRep(),trips.get(position).getUser(),null);
        ...
        holder.startbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context,"tmap pressed",Toast.LENGTH_SHORT).show();
                SQLAdapter adapter = new SQLAdapter(context);
                long i2 = adapter.updateTrip(trips.get(position).getId(),trips.get(position).getName(),trips.get(position).getSp(),trips.get(position).getSlong(),trips.get(position).getSlat(),trips.get(position).getEp(),trips.get(position).getElong(),trips.get(position).getElat(), "Done",sdate,sdate,stime,stime,trips.get(position).getRep(),trips.get(position).getUser(),null);
                ...
                if(trips.get(position).getRep()!=0) {
                    ...
                    long i = adapter.insertTrip(trips.get(position).getName(), trips.get(position).getSp(), trips.get(position).getSlong(), trips.get(position).getSlat(), trips.get(position).getEp(), trips.get(position).getElong(), trips.get(position).getElat(), "upcoming", tripdate, null, trips.get(position).getSt(), trips.get(position).getSt(), trips.get(position).getRep(), trips.get(position).getUser(), null);
